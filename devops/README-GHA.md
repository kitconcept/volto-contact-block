...
2. Go to your repository at [kitconcept/volto-contact-block](https://github.com/kitconcept/volto-contact-block).
...
- [Backend Tests Workflow](https://github.com/kitconcept/volto-contact-block/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/kitconcept/volto-contact-block/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/kitconcept/volto-contact-block-backend`) and Frontend (`ghcr.io/kitconcept/volto-contact-block-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of volto-contact-block.example.com](https://github.com/kitconcept/volto-contact-block/actions/workflows/manual-deploy.yml).
