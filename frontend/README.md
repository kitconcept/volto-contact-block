...
[![npm](https://img.shields.io/npm/v/@kitconcept/volto-contact-block)](https://www.npmjs.com/package/@kitconcept/volto-contact-block)
[![](https://img.shields.io/badge/-Storybook-ff4785?logo=Storybook&logoColor=white&style=flat-square)](https://kitconcept.github.io/volto-contact-block/)
...
Add `@kitconcept/volto-contact-block` to your `package.json`.
...
Add `@kitconcept/volto-contact-block` to your `volto.config.js`.
...
```javascript
const theme = '@kitconcept/volto-contact-block';
```
...
yo @plone/volto my-volto-project --addon @kitconcept/volto-contact-block
cd my-volto-project
```
